...
class SettingsMenu(room.Room):
    ...
    def __init__(self):
        ...
        self.fullscreen_btn = gui.CheckBox(_("Toggle Fullscreen"), f.MAIN, callback=lambda _, _a: display.toggle_fullscreen())
        def res_setter(res):
        ...
        self.resolutions_menu = gui.Menu(resolutions, f.MAIN)
